...
Lifted from:
  - mmfld/circuit_map.py L85-254 (compute_circuit_correlations)
"""
...
def compute_circuit_correlations(X, col_names, min_corr=0.3):
    ...
    Source: mmfld/circuit_map.py L85-254
    """
    n_cols = X.shape[1]
    ...
    # Source: mmfld/circuit_map.py L111-142
    if numeric_idx:
        Xnum = X[:, numeric_idx]
    ...
    # Source: mmfld/circuit_map.py L146-200
    reg_token_sets = {}
    if categ_idx:
    ...
    # --- Spearman rank correlation on token ID columns ---
    # Source: mmfld/circuit_map.py L204-251
