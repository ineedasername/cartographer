...
Lifted from:
  - negation/deberta_differential.py L91-98  (group_by)
  - negation/deberta_differential.py L101-129 (diff_analysis)
"""
...
def group_by(examples, key_fn):
    ...
    Source: negation/deberta_differential.py L91-98
    """
...
def diff_analysis(matrices, reg_names, group_a_indices, group_b_indices,
    ...
    Source: negation/deberta_differential.py L101-129
    """
