...
Source attribution:
  - HeadScaleHook: medgemma/intervene_heads.py L114-128
  - HeadZeroHook: negation/head_ablation.py L62-76
  - HeadSubtractHook: mmfld/intervene_h6_clean.py L138-149
  - DirectionalNudgeHook: negation/intervene_h2.py L146-165
  - MLPNudgeHook: negation/intervene_mlp.py L97-107
  - LogitBiasHook: medgemma/intervene_logits.py L150-173
  - compute_nudge_direction: negation/intervene_h2.py L53-110
  - compute_mlp_nudge_direction: negation/intervene_mlp.py L43-63
"""
...
# Source: medgemma/intervene_heads.py L114-128
# ---------------------------------------------------------------------------
...
# Source: negation/head_ablation.py L62-76
# ---------------------------------------------------------------------------
...
# Source: mmfld/intervene_h6_clean.py L138-149
# ---------------------------------------------------------------------------
...
# Source: negation/intervene_h2.py L146-165
# ---------------------------------------------------------------------------
...
# Source: negation/intervene_mlp.py L97-107
# ---------------------------------------------------------------------------
...
# Source: medgemma/intervene_logits.py L150-173
# ---------------------------------------------------------------------------
...
def compute_nudge_direction(model, target_head: int, target_layer: int,
    ...
    Source: negation/intervene_h2.py L53-110
...
def compute_mlp_nudge_direction(model, from_class: int, to_class: int,
    ...
    Source: negation/intervene_mlp.py L43-63
