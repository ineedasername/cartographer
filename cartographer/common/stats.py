"""Shared statistical functions used across the cartographer ecosystem.

Lifted from:
  - rank_scan.py L106-118 (compute_spearman_fast)
  - rank_scan.py L114 (rank_tokens pattern)
  - negation/deberta_differential.py L121-123 (cohens_d)
  - medgemma/find_knowledge_heads.py L35-45 (cohens_d Bessel variant)
  - mmfld/circuit_map.py L186-196 (jaccard_topk)
"""
...
def cohens_d(group_a, group_b, bessel=False):
    ...
    Source: negation/deberta_differential.py L121-123 (pooled SD)
            medgemma/find_knowledge_heads.py L35-45 (Bessel-corrected)
...
def jaccard_topk(sets_a, sets_b):
    ...
    Source: mmfld/circuit_map.py L186-196
