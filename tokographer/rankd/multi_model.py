...
log = logging.getLogger("tokographer.rankd.multi_model")
...
def scan_model(model_id, prompt, db_path, gen_tokens=30, label=None, dtype=None):
    ...
    """
    from tokographer.inspect.model import load_model_simple
    from tokographer.rankd.scan import init_db, capture_baseline, run_scan
...
def scan_with_perturbation(model_id, prompt, db_path, token_id_or_str,
    ...
    from tokographer.inspect.model import load_model_simple
    from tokographer.rankd.scan import init_db, capture_baseline, run_scan
    from tokographer.intervene.embedding import EmbeddingPerturbation
