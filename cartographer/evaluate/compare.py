...
Source: negation/export_intervention_cases.py (8-category classification, lines 125-142)
"""
...
def categorize_changes(
    ...
    Source pattern: negation/export_intervention_cases.py lines 125-142
    """
